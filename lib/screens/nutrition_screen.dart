...
class NutritionScreen extends StatelessWidget {
  ...
  final void Function(int) onUpdateBurnedToday;
  ...
  const NutritionScreen({
    ...
    required this.onUpdateBurnedToday,
    ...
    final updated = await Navigator.of(context).push<MealEntry>(
      MaterialPageRoute(
        builder: (_) => LogMealScreen(
          ...
          onSaveToCookbook: onAddCookbookMeal,
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    // For now: same goal every day.
    // Later: you can return different NutritionGoal per weekday or per program.
            ...
            onPressed: () async {
              final entry = await Navigator.of(context).push<MealEntry>(
                MaterialPageRoute(
                  builder: (_) => LogMealScreen(
                    nutritionGoal: nutritionGoal,
                    cookbookMeals: cookbookMeals,           // 🔹 NEW
                    onSaveToCookbook: onAddCookbookMeal,   // 🔹 NEW
                  ),
                ),
              );
              if (entry != null) {
                ...
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // 🔹 Vertically centred ring + bars
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          buildCalorieRing(energyMode),

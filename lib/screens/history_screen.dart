            ...
            onPressed: () async {
              ...
              if (createdCount != null && createdCount > 0) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Planned $createdCount workouts.'),
                  ),
                );
                onSessionsChanged();
              }
...
class _WorkoutTile extends StatelessWidget {
  ...
  Future<void> _confirmDelete(BuildContext context) async {
    ...
    if (result == true) {
      ...
      // ✅ IMPORTANT: force parent to rebuild so this list updates immediately
      onSessionsChanged();
    ...
    return Card(
      ...
      child: ListTile(
        onTap: () async {
          ...
          // ✅ After returning, refresh list (covers edits + marking complete)
          onSessionsChanged();
        },
        title: Row(
          children: [
            ...
            Chip(
              label: Text(isPlanned ? 'Planned' : 'Completed'),
